...
import static net.osdn.gokigen.pkremote.camera.vendor.pixpro.wrapper.command.messages.IPixproMessages.SEQ_CONNECT_05;

public class PixproConnectSequence05 extends PixproCommandBase
{
    private final IPixproCommandCallback callback;

    public PixproConnectSequence05(@Nullable IPixproCommandCallback callback)
    {
