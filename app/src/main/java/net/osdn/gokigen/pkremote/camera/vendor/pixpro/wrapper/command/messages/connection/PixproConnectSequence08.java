...
import static net.osdn.gokigen.pkremote.camera.vendor.pixpro.wrapper.command.messages.IPixproMessages.SEQ_CONNECT_08;

public class PixproConnectSequence08 extends PixproCommandBase
{
    private final IPixproCommandCallback callback;

    public PixproConnectSequence08(@Nullable IPixproCommandCallback callback)
    {
