package net.osdn.gokigen.pkremote.camera.vendor.pixpro.operation;
 ...
 *
 */
public class CameraPowerOffPixpro implements Preference.OnPreferenceClickListener, ConfirmationDialog.Callback
{
     ...
     *
     */
    public CameraPowerOffPixpro(Context context, IChangeScene changeScene)
    {
