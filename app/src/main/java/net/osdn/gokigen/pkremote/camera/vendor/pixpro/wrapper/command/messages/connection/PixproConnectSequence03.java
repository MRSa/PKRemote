...
import static net.osdn.gokigen.pkremote.camera.vendor.pixpro.wrapper.command.messages.IPixproMessages.SEQ_CONNECT_03;

public class PixproConnectSequence03 extends PixproCommandBase
{
    private final IPixproCommandCallback callback;

    public PixproConnectSequence03(@Nullable IPixproCommandCallback callback)
    {
