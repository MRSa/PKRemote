...
public class PtpIpFocusingControl implements IFocusingControl, IPtpIpCommandCallback
{
    ...
    public PtpIpFocusingControl(@NonNull Activity activity, @NonNull IPtpIpCommandPublisher issuer, @NonNull final IAutoFocusFrameDisplay frameDisplayer, @NonNull final IIndicatorControl indicator)
    {
        this.issuer = issuer;
